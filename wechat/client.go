...
func (c *Client) SetHeader(ctx context.Context, url, method string, requestBody interface{}, header map[string]string) (http.Header, error) {
	...
	if authorization, err = c.GenerateAuthorizationHeader(ctx, method, request.URL.RequestURI(), body.String()); err != nil {
		return nil, err
	}
...
func (c *Client) Get(ctx context.Context, url string) (*http.Response, error) {
	headers, err := c.SetHeader(ctx, url, http.MethodGet, "", nil)
	if err != nil {
		return nil, err
	}
	return utils.Request(ctx, http.MethodGet, url, headers, nil, "")
}
...
func (c *Client) Post(ctx context.Context, url string, header map[string]string, requestBody interface{}) (*http.Response, error) {
	headers, err := c.SetHeader(ctx, url, http.MethodPost, requestBody, header)
	if err != nil {
		return nil, err
	}
	body, err := utils.SetBody(requestBody, header[utils.ContentType])
	...
	return utils.Request(ctx, http.MethodPost, url, headers, body, body.String())
}
...
func (c *Client) Patch(ctx context.Context, url string, requestBody interface{}) (*http.Response, error) {
	headers, err := c.SetHeader(ctx, url, http.MethodPatch, requestBody, nil)
	if err != nil {
		return nil, err
	}
	...
	return utils.Request(ctx, http.MethodPatch, url, headers, body, body.String())
}
...
func (c *Client) Upload(ctx context.Context, url, meta, requestBody string, header map[string]string) (*http.Response, error) {
	headers, err := c.SetHeader(ctx, url, http.MethodPost, meta, header)
	if err != nil {
		return nil, err
	}
	body, err := utils.SetBody(requestBody, header[utils.ContentType])
	...
	return utils.Request(ctx, http.MethodPost, url, headers, strings.NewReader(requestBody), body.String())
}
